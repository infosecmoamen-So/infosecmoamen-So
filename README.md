...
<h2>🛡️ Governance, Risk, and Compliance (GRC) Projects:</h2>

- <b>NIST Framework Assessment & Security Audit (Botium Toys)</b>
  - <a href="[ضع هنا رابط ملف CONTROLS_ASSESSMENT في حسابك]">Internal Security Audit & Controls Assessment</a> - Performed a full NIST CSF alignment, mapping and prioritizing administrative, technical, and physical controls.
  - <a href="[ضع هنا رابط ملف COMPLIANCE_CHECKLIST في حسابك]">Regulatory Compliance Checklist</a> - Evaluated international regulations including GDPR, PCI DSS, and SOC compliance frameworks for a global retail environment[cite: 4].
